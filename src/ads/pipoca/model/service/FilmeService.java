...
public class FilmeService {
	...
	public ArrayList<Filme> listarFilmes(ArrayList<Integer> lista) throws IOException { //sobrecarga
		ArrayList<Filme>movies = new ArrayList<>();
		for(int id:lista) {
			movies.add(buscarFilme(id));
		}
		return movies;
	}
	...
	public void finalizarFilme(Filme filme) throws IOException{
		dao.atualizarFilme (filme);
	}
}
