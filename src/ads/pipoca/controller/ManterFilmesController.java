...
public class ManterFilmesController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		switch(acao) {
		case "new/menu-de-menu-jsp":
			generos = gService.listarGeneros();
			request.setAttribute("generos", generos);
			saida = "InserirFilme.jsp";
			break;
		case "btn/visualizar-de-listarFilmes-jsp":
		...
		case "btn/mostrar-de-mostrar-filme-jsp":
			...
			saida = "Filme.jsp";
			break;
		case "bnt/inserir-de-inserir-filme-jsp":
			...
			saida = "Filme.jsp";
			break;
		case "btn/editar-de-listarFilmes-jsp":
			pars = request.getParameterNames();
			listaIds = new ArrayList<>();
			try {
				while ((par = pars.nextElement()) != null) {
		...
		case "btn/atualizar-de-atualizar-filme-jsp":
			...
			saida = "Filme.jsp";
			break;
		case "btn/excluir-de-modal-listarFilmes-jsp":
			pars = request.getParameterNames();
			listaIds = new ArrayList<>();
