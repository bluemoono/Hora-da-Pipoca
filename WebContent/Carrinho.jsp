	...
	<div class="modal fade" id="delete-modal" tabindex="-1" role="dialog">
		...
		<hr>
			<div id="actions" class="row">
				<div class="col-md-12">
					<button type="submit" id="btnComprar" name="acao" value="btn/comprar-de-carrinho-jsp" class="btn btn-primary" disabled>Finalizar Compra</button>
					...
					<button type="button" class="btn btn-danger" id="btnExcluir" data-toggle="modal" data-target="#delete-modal" value="btn/excluir-de-carrinho-jsp" disabled>Excluir</button>
					<a href="comprar_filmes.do?acao=menu/comprarFilmes-de-menu-jsp" class="btn btn-default">Voltar</a>
				</div>
			</div>
		</form>
		<br><br><br>
