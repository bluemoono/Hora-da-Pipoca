	...
	<div class="modal fade" id="delete-modal" tabindex="-1" role="dialog">
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-footer">
		        ...
		        <button type="submit" name="acao" value="btn/excluir-de-modal-listarFilmes-jsp" class="btn btn-danger">Excluir</button>
		      </div>
		    </div><!-- /.modal-content -->
		  </div><!-- /.modal-dialog -->
	</div><!-- /.modal -->
		...
		<hr>
			<div id="actions" class="row">
				<div class="col-md-12">
					<button type="submit" id="btnEditar" name="acao" value="btn/editar-de-listarFilmes-jsp" class="btn btn-primary" disabled>Editar</button>
					<button type="submit" id="btnVisualizar" name="acao" value="btn/visualizar-de-listarFilmes-jsp" class="btn btn-info" disabled>Visualizar</button>
					<button type="button" class="btn btn-danger" id="btnExcluir" data-toggle="modal" data-target="#delete-modal" value="btn/excluir-de-modal-listarFilmes-jsp" disabled>Excluir</button>
