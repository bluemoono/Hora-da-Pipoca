	...
	<div class="modal fade" id="delete-modal" tabindex="-1" role="dialog">
		...
		<hr>
			<div id="actions" class="row">
				<div class="col-md-12">
					<button type="submit" id="btnVisualizar" name="acao" value="btn/visualizar-de-exibirFilmes-jsp" class="btn btn-info" disabled>Visualizar</button>
					<button type="submit" class="btn btn-success" id="btnComprar"  name="acao" value="btn/comprar-de-exibirFilmes-jsp" disabled>Comprar</button>
